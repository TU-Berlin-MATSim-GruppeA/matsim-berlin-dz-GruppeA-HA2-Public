...
public final class RunBerlinScenario_PlanB_Network1_Version1 {

	private static final Logger log = Logger.getLogger(RunBerlinScenario_PlanB_Network1_Version1.class );
	...
	public static void main(String[] args) {
		...
		if ( args.length==0 ) {
			...
			// PlanB_Network1_Version1
			args = new String[] {"scenarios/berlin-v5.5-1pct/input/PlanB/berlin-v5.5-1pct.config_PlanB_Network1_Version1.xml"}  ;
			//******changes in PlanB_Network1_Version1******//
