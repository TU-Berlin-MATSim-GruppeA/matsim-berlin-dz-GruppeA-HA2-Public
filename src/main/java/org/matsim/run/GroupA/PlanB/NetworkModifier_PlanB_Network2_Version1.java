 ...
 * @author dziemke
 */
public class NetworkModifier_PlanB_Network2_Version1 {
    private static final Logger LOG = Logger.getLogger(NetworkModifier_PlanB_Network2_Version1.class);

    public static void main (String[] args) throws IOException {
        // Input and output files
        String networkInputFile = "scenarios/berlin-v5.5-1pct/input/berlin-v5.5-network.xml.gz";
        String networkOutputFile = "scenarios/berlin-v5.5-1pct/input/PlanB/network-modified-carInternal_Network2.xml.gz";
