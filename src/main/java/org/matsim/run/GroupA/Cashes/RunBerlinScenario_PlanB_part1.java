...
public final class RunBerlinScenario_PlanB_part1 {

	private static final Logger log = Logger.getLogger(RunBerlinScenario_PlanB_part1.class );
	...
	public static void main(String[] args) {
		...
		if ( args.length==0 ) {
			...
			// PlanB part1
			args = new String[] {"/Users/haowu/Workspace/fixedRepository/matsim-berlin-dz/scenarios/berlin-v5.5-1pct/input/PlanB/berlin-v5.5-1pct.config_PlanB_part1.xml"}  ;
		...
		//delete initial routes for all agents!
