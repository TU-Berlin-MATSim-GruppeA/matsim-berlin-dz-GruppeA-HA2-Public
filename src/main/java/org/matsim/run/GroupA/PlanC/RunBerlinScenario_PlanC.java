...
public final class RunBerlinScenario_PlanC {

	private static final Logger log = Logger.getLogger(RunBerlinScenario_PlanC.class );
	...
	public static void main(String[] args) {
		...
		if ( args.length==0 ) {
			...
			// Plan C
			args = new String[] {"/Users/haowu/Workspace/fixedRepository/matsim-berlin-dz/scenarios/berlin-v5.5-1pct/input/PlanC/berlin-v5.5-1pct.config_PlanC.xml"}  ;
			//******changes in PlanC******//
