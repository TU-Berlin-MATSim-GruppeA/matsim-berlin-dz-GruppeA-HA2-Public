package org.matsim.run.GroupA.analysis.FromJavier;
...
public class RunEventsHandler {
    public static void main(String args[]) throws IOException, ParserConfigurationException, SAXException {
        ...
        // PlanB 100Iterations
        String inputFile = "scenarios/berlin-v5.5-1pct/output-berlin-v5.5-1pct_PlanB_Network2_Version1_secondSuccessfulRun_100Iterations/berlin-v5.5-1pct.output_events.xml";
