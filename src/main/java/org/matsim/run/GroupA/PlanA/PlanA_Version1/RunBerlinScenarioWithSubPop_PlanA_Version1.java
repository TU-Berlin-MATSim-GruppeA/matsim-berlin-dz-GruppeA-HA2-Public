...
public final class RunBerlinScenarioWithSubPop_PlanA_Version1 {

	private static final Logger log = Logger.getLogger(RunBerlinScenarioWithSubPop_PlanA_Version1.class );
	...
	public static void main(String[] args) {
		...
		if ( args.length==0 ) {
			...
			//PlanA_Version1
			args = new String[] {"/Users/haowu/Workspace/fixedRepository/matsim-berlin-dz/scenarios/berlin-v5.5-1pct/input/PlanA/berlin-v5.5-1pct.config-subpop_PlanA_Version1.xml"}  ;
			//******changes in PlanA_Version1******//
