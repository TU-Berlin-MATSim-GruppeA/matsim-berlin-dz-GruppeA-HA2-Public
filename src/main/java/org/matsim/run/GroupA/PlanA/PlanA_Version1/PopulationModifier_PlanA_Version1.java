...
public class PopulationModifier_PlanA_Version1 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String plansInputFile = "scenarios/berlin-v5.5-1pct/input/berlin-v5.5-1pct.plans.xml.gz";
        String plansOutputFile = "scenarios/berlin-v5.5-1pct/input/PlanA/plans-modified-carInternal.xml.gz";
        //String areaShapeFile = "/Users/haowu/Workspace/QGIS/MATSim_HA2/ColoredStreets/NoCarZone_final.shp";

        String outputFile_ResidentsReader = "scenarios/berlin-v5.5-1pct/input/PlanA/personInternalIDsList.txt";
