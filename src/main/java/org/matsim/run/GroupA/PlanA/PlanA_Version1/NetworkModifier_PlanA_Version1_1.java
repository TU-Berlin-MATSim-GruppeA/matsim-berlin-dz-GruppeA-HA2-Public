 ...
 * @author dziemke
 */
public class NetworkModifier_PlanA_Version1_1 {
    private static final Logger LOG = Logger.getLogger(NetworkModifier_PlanA_Version1_1.class);
    ...
    public static void main (String[] args) throws IOException {
        ...
        String networkOutputFile = "/Users/haowu/Workspace/fixedRepository/matsim-berlin-dz/scenarios/berlin-v5.5-1pct/input/PlanA/network-modified-carInternal.xml.gz";
